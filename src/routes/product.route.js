...
router.post("/", customPassport.passportJWTAdmin, productController.upload, productController.newProduct);
router.put("/edit", customPassport.passportJWTAdmin, productController.upload, productController.editProduct);
router.delete("/delete", customPassport.passportJWTAdmin, productController.deleteProduct);
